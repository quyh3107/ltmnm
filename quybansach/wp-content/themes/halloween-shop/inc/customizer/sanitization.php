 ...
 */
function halloweenshop_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function halloweenshop_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function halloweenshop_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function halloweenshop_sanitize_float( $input ) {
 ...
 */
function halloweenshop_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function halloweenshop_sanitize_html( $html ) {
 ...
 */
function halloweenshop_sanitize_image( $image, $setting ) {
 ...
 */
function halloweenshop_sanitize_nohtml( $nohtml ) {
 ...
 */
function halloweenshop_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function halloweenshop_sanitize_range_value( $number, $setting ) {
 ...
 */
function halloweenshop_sanitize_select( $input, $setting ) {
 ...
 */
function halloweenshop_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function halloweenshop_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function halloweenshop_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
